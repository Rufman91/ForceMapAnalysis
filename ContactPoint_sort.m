function [f_loadS_OFF ,data_unload_final,position,yoffset] = ContactPoint_sort(smoothed_load, smoothed_unloadS)
...
sub2(:,1) = sub1(:,1) - ytemp2(:,1); % LOAD
    sub1_unload(:,1) = sub1_unload(:,1) - ytemp_unload2(:,1); % UNLOAD
data_unload2(:,2) = data_unload(:,2) - ytemp_unload2(:,1);

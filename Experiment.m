...
%             end
        ...
        function FMAOptions = set_default_fma_options()
            ...
            FMAOptions = struct('ContactPointOption','Old',...
                ...
                'AutomaticFibril','FromArea','SetAllToValue','UserInput',...
                'FromRefFM','AutomaticFibril'}},...
                'SetAllToValue',1,...
                'SetValue',[],...
        ...
        function GrammOptions = set_default_gramm_options()
            ...
            Statistical = struct(...
                ...
                'Summary type','ci',...
                'AllowedSummary type',{{'ci','bootci','sem','std','quartile',...
                '95percentile','fitnormalci','fitpoissonci','fitbinomialci'}},...
                'TooltipSummary type','Method of Bar Height calculation',...
                'Summary geom','area',...
                'AllowedSummary geom',{{'area','lines','line','solid_area',...
                'black_errorbar','errorbar','bar','point','area_only'}},...
                'TooltipSummary geom','Determines how means and errorbars are represented',...
                'Summary setylim',true,...
                'DTypeSummary setylim','logical',...
                'TooltipSummary setylim','Do we set the YLim for the subplot according to the summary or the data?',...
                'Summary width',.6...
                );
            
            GrammOptions = struct(...
                'GroupingStyle','lightness',...
                'AllowedGroupingStyle',{{'lightness','linestyle',...
                'marker','size'}},...
                'ymin',[],...
                'DTypeymin','double',...
                'ymax',[],...

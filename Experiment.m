...
%             end
        ...
        function GrammOptions = set_default_gramm_options()
            ...
            Statistical = struct(...
                ...
                'geom','area',...
                'Allowedgeom',{{'area','lines','line','solid_area',...
                'black_errorbar','errorbar','bar','point','area_only'}},...
                'Tooltipgeom','Determines how means and errorbars are represented in summary, smooth, glm and fit',...
                'Summary_type','ci',...
                ...
                'QQ_distribution',"makedist('Normal',0,1)",...

classdef Experiment < matlab.mixin.Copyable
    ...
    methods
        ...
        function force_map_analysis_fibril(obj,CPOption,EModOption)
            ...
            %
            % ApexOption = 'Apex' ... Just analyses curves from the fibril
            % apex. Is vastly faster than analysisng all curves, though one
            % loses access to EModMaps
            % ApexOption = 'All' ... Analyse all force curves in the map. Very slow but
            % complete with EModMap

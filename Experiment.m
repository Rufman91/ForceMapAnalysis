                    ...
                    if isequal(lower(EModOption),'hertz') || isequal(lower(EModOption),'both') || isequal(lower(EModOption),'hertzcorrected')
                        ...
                        if UseTipInHertz
                            obj.FM{i}.calculate_e_mod_hertz(CPOption,...
                                ...
                                obj.ForceMapAnalysisOptions.EModOption.Hertz.TopologyHeightChannel,...
...
%             end
        ...
        function FMAOptions = set_default_fma_options()
            ...
            Hertz = struct(...
                ...
                'TopologyHeightChannel','Processed',...
                'AllowedTopologyHeightChannel',{{'Processed','Contact Height','Deconvoluted','Height','Height (measured)'}},...
                'ThinFilmMode','From Topology',...
                'AllowedThinFilmMode',{{'From Topology','From Value'}},...

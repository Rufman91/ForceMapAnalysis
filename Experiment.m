...
%                         obj.save_experiment;
        ...
        function SMFS_results_structure(obj,ExtVelocityValue,RetVelocityValue,HoldingTimeValue,SubstrateValue,EnvCondValue,ChipCantValue,ChipboxValue,LinkerValue)
            ...
            % Statistics
                ...
                AdhMaxAppMinFc=AdhMaxAppMinFc(AdhMaxAppMinIdx,1)-(AdhMaxAppMinFM-AdhMaxAppMinFM+1)*100;
                AdhMaxAppMaxFc=AdhMaxAppMaxFc(AdhMaxAppMaxIdx,1)-(AdhMaxAppMaxFM-AdhMaxAppMaxFM+1)*100;
                ...
                AdhMaxRetMinFc=AdhMaxRetMinFc(AdhMaxRetMinIdx,1)-(AdhMaxRetMinFM-AdhMaxRetMinFM+1)*100;
                AdhMaxRetMaxFc=AdhMaxRetMaxFc(AdhMaxRetMaxIdx,1)-(AdhMaxRetMaxFM-AdhMaxRetMaxFM+1)*100;               
                ...
                AdhMaxRetUnbindingMinFc=AdhMaxRetUnbindingMinFc(AdhMaxRetUnbindingMinIdx,1)-(AdhMaxRetUnbindingMinFM-AdhMaxRetUnbindingMinFM+1)*100;
                AdhMaxRetUnbindingMaxFc=AdhMaxRetUnbindingMaxFc(AdhMaxRetUnbindingMaxIdx,1)-(AdhMaxRetUnbindingMaxFM-AdhMaxRetUnbindingMaxFM+1)*100;
                ...
                AdhEneAppMinFc=AdhEneAppMinFc(AdhEneAppMinIdx,1)-(AdhEneAppMinFM-AdhEneAppMinFM+1)*100;
                AdhEneAppMaxFc=AdhEneAppMaxFc(AdhEneAppMaxIdx,1)-(AdhEneAppMaxFM-AdhEneAppMaxFM+1)*100;
                ...
                AdhEneRetMinFc=AdhEneRetMinFc(AdhEneRetMinIdx,1)-(AdhEneRetMinFM-AdhEneRetMinFM+1)*100;
                AdhEneRetMaxFc=AdhEneRetMaxFc(AdhEneRetMaxIdx,1)-(AdhEneRetMaxFM-AdhEneRetMaxFM+1)*100;              
                ...
                PullLengthMinFc=PullLengthMinFc(PullLengthMinIdx,1)-(PullLengthMinFM-PullLengthMinFM+1)*100;
                PullLengthMaxFc=PullLengthMaxFc(PullLengthMaxIdx,1)-(PullLengthMaxFM-PullLengthMaxFM+1)*100;                
                ...
                SnapInMinFc=SnapInMinFc(PullLengthMinIdx,1)-(SnapInMinFM-SnapInMinFM+1)*100;
                SnapInMaxFc=SnapInMaxFc(PullLengthMaxIdx,1)-(SnapInMaxFM-SnapInMaxFM+1)*100;            
        ...
        function SMFS_results_gramm_boxplot2(obj,ii)
            ...
            NameSuffix1='_MaxAdhesionForceApproach';
            % Allocate data
            xData1=obj.SMFSResults{ii}.Concatenate.FMID;
            yData1=obj.SMFSResults{ii}.Data.AdhMaxAppConcat; 
            ColorData1=FMExtVeloData;
            LightnessData1=FMRetVeloData;
            MarkerData1=obj.SMFSResults{ii}.Concatenate.FMHoldingTime;
            % Create a gramm object
            g1=gramm('x',xData1,'y',yData1,...
                'color',ColorData1,...
                'lightness',LightnessData1,...
                'marker',MarkerData1);
            % Plot data 
            g1.geom_polygon('y',{LimitForce1;LimitForce2;LimitForce3},'color',ColorMap1);
            g1.geom_jitter('width',0.1,...
                'dodge',0.1); % Plot raw data as jitter
            g1.stat_boxplot('notch',true,...
                'width',0.1,...
                'dodge',0.2); % Plot data in boxplot           
            g1.set_title(Plottitle) %Set figure title
            % Legend
            g1.set_names('x',LegendxAxis,'y',LegendyAxis,'color',LegendColor,'column',ColumnName)    
            % Figure

...
%                         'FontSize',obj.ShowImageSettings.ReferenceFontSize);
            ...
            function get_and_draw_volume_information(varargin)
                ...
                if isequal(varargin{1}.Parent,h.ImAx(1))
                    h.VolumeStruct.Index = 1;
                elseif isequal(varargin{1}.Parent,h.ImAx(2))
                    h.VolumeStruct.Index = 2;
                end
            ...
            function draw_volume_information(varargin)
                ...
                % get, scale and process requested data according to chosen
                % options
                if h.FVM(6).Value
                    BaseUnitX = 's';
                else
                ...
                if obj.ShowImageSettings.PlotTime
                    ...
                    TimeApp = (HHApp - HHApp(1))./Class{h.VolumeStruct.Index}.ExtendVelocity;
                    TimeRet = (-HHRet + HHRet(1))./Class{h.VolumeStruct.Index}.RetractVelocity...
                ...
                if h.FVM(8).Value == 1
                    if h.FVM(5).Value
                        Y1 = App.*(Class{h.VolumeStruct.Index}.RefSlopeCorrectedSensitivity/...
                            Class{h.VolumeStruct.Index}.Sensitivity);
                        Y2 = Ret.*(Class{h.VolumeStruct.Index}.RefSlopeCorrectedSensitivity/...
                            Class{h.VolumeStruct.Index}.Sensitivity);
                    else
                        Y1 = App;
                        Y2 = Ret;
                ...
                elseif h.FVM(8).Value == 2
                    if h.FVM(5).Value
                        Y1 = App./Class{h.VolumeStruct.Index}.SpringConstant...
                            .*(Class{h.VolumeStruct.Index}.RefSlopeCorrectedSensitivity/...
                            Class{h.VolumeStruct.Index}.Sensitivity);
                        Y2 = Ret./Class{h.VolumeStruct.Index}.SpringConstant...
                            .*(Class{h.VolumeStruct.Index}.RefSlopeCorrectedSensitivity/...
                            Class{h.VolumeStruct.Index}.Sensitivity);
                    else
                        Y1 = App./Class{h.VolumeStruct.Index}.SpringConstant;

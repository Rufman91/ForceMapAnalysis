classdef ForceMap < handle
    ...
    properties
        ...
        load_old        % comes from same script as CP_old
        unload_old      % comes from same script as CP_old
        deltaE = {}     %
    ...
    methods
        ...
        function old_CP(obj)
            ...
            for i=iRange'
                ...
                [obj.load_old{i},obj.unload_old{i},Position,obj.CP_old(i,2)] = ContactPoint_sort(load,unload);

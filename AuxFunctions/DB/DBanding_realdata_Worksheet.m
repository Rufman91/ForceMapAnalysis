...
%     noisy_signal_final = interp1(X,noisy_signal_final,XQ,'makima');
    [period(i), amplitude(i), y_filtered] = DB_find_spatial_frequency(XQ, noisy_signal_final, lower_cutoff, upper_cutoff, padding_factor,true);
    peak_skewness_plus = DB_periodic_signal_skewness(XQ, y_filtered, period(i));
    peak_skewness_minus = -DB_periodic_signal_skewness(XQ, -y_filtered, period(i));
